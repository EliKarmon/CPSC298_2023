...
int main()
{
	...
	// Set p_nodeHead to point to the head or leading node
	// in the list of nodes, in this case p_node1.
	Node<double>* p_nodeHead2 = p_node4;
	p_node4->mp_nodeNext = p_node5; // append p_node2 to the list of Node objects after p_node1.
	p_node5->mp_nodeNext = p_node6; // append p_node3 to the list of Node objects after p_node2.
	p_node6->mp_nodeNext = nullptr; // The end of the list is indicated by a mp_nodeNext value of nullptr.

	Node<double>::displayList(p_nodeHead2);  // display the list of nodes to standard output.
}
